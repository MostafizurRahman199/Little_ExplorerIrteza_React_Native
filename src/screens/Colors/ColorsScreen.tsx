...
type Props = { navigation: NativeStackNavigationProp<RootStackParamList, 'Colors'> };

export const ColorsScreen: React.FC<Props> = ({ navigation }) => (
  <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.categoryColors }]}>
    ...
    <View style={styles.body}>
      ...
      <Text style={styles.title}>Color Discovery</Text>
