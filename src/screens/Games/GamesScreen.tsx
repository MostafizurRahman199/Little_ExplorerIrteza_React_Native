...
export const GamesScreen: React.FC<Props> = ({ navigation }) => (
  <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.categoryGames }]}>
    <View style={styles.header}>
      <BackButton onPress={() => navigation.goBack()} />
      <Text style={styles.headerTitle}>🎮 Toddler Games</Text>
    </View>
    <View style={styles.body}>
      <Text style={styles.emoji}>🎈 🐶 🔴 🫧 🧩</Text>
      <Text style={styles.title}>Simple Play Games</Text>
      <Text style={styles.subtitle}>Phase 13 Module Ready</Text>
    </View>
  </SafeAreaView>
);
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: theme.fontSize.lg, fontWeight: theme.fontWeight.bold, marginLeft: theme.spacing.md, color: theme.colors.secondaryDark },
