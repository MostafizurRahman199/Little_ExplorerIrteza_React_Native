...
type Props = { navigation: NativeStackNavigationProp<RootStackParamList, 'ABC'> };

export const ABCScreen: React.FC<Props> = ({ navigation }) => (
  <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.categoryAbc }]}>
    ...
    <View style={styles.body}>
      <Text style={styles.emoji}>🅰️ 🅱️ 🅰️ 🍎 🎈</Text>
      <Text style={styles.title}>Letter & Word Fun</Text>
      <Text style={styles.subtitle}>Phase 6 Module Ready</Text>
    </View>
  </SafeAreaView>
);
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: theme.fontSize.lg, fontWeight: theme.fontWeight.bold, marginLeft: theme.spacing.md, color: theme.colors.accentBlue },
