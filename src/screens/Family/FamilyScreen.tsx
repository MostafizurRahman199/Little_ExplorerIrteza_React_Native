...
type Props = { navigation: NativeStackNavigationProp<RootStackParamList, 'Family'> };
...
export const FamilyScreen: React.FC<Props> = ({ navigation }) => (
  <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.categoryFamily }]}>
    ...
    <View style={styles.body}>
      ...
      <Text style={styles.title}>Personalized Family Album</Text>
      <Text style={styles.subtitle}>Phase 9 Module Ready</Text>
    </View>
  </SafeAreaView>
);
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: theme.fontSize.lg, fontWeight: theme.fontWeight.bold, marginLeft: theme.spacing.md, color: theme.colors.primary },
