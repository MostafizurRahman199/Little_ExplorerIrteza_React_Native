...
type Props = { navigation: NativeStackNavigationProp<RootStackParamList, 'Vehicles'> };

export const VehiclesScreen: React.FC<Props> = ({ navigation }) => (
  <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.categoryVehicles }]}>
    ...
    <View style={styles.body}>
      ...
      <Text style={styles.title}>Vehicle World</Text>
      <Text style={styles.subtitle}>Phase 7 Module Ready</Text>
    </View>
  </SafeAreaView>
);
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: theme.fontSize.lg, fontWeight: theme.fontWeight.bold, marginLeft: theme.spacing.md, color: theme.colors.accentOrange },
