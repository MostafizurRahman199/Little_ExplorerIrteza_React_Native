...
export const BodyCard: React.FC<BodyCardProps> = ({ bodyItem, onPress, index = 0 }) => {
    ...
    >
      <Animated.View
        style={[
          styles.card,
          {
            backgroundColor: bodyItem.bgColor,
            opacity: opacityAnim,
      ...
      >
        ...
        <Text style={[styles.name, { color: bodyItem.accentColor }]}>{bodyItem.name}</Text>
      </Animated.View>
    </TouchableWithoutFeedback>
  );
};
